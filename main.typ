...
Understanding how @ML #footnote[This report uses a lot of abbreviations and complex terms. A glossary is available at #ref(<gls>, form: "page").] systems operate requires knowledge of computer architecture, which is essentially the design and structure of a computer's internal components, such as the @CPU, memory, and @IO systems. Traditional @CPU:pl are designed for general-purpose tasks, handling sequential instructions efficiently. However, @ML computations, such as @DL and neural networks, require parallel processing capabilities (#cite(<abderrahmane2020Design>, form: "prose"), #cite(<kovacevic2022RISC-V>, form: "prose"), #cite(<BriefOverviewEdgeAIAccelerators>, form: "prose")). Here, architectures like the kinds used in @GPU:pl @EmbeddedEdgeAiDev or the @RISCV @kovacevic2022RISC-V become crucial.
